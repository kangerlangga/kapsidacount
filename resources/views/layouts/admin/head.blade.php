    ...
    <title>{{ $judul }} | Kapsida Count Admin</title>
	...
	<script>
		WebFont.load({
			...
			custom: {"families":["Flaticon", "Font Awesome 5 Solid", "Font Awesome 5 Regular", "Font Awesome 5 Brands", "simple-line-icons"], urls: ['{{  url('') }}/assets/admin/css/fonts.min.css']},
			active: function() {
	...
	<link rel="stylesheet" href="{{  url('') }}/assets/admin/css/atlantis.min.css">
